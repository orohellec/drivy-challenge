...
class Rental
  ...
  def resume
    ...
    commission = calcul_commisions_price(total_price)
    {id: @id, price: total_price, commission: commission}
  end
  ...
  def calcul_commisions_price(total_price)
    commision_price = (total_price * 0.3).to_i
    insurance_fee = (commision_price / 2).to_i
    assistance_fee = @rental_days * 100
    drivy_fee = commision_price - insurance_fee - assistance_fee
